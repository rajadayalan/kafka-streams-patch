...
public class LogAndSkipOnInvalidTimestamp extends ExtractRecordMetadataTimestamp {
    ...
    public long onInvalidTimestamp(final ConsumerRecord<Object, Object> record,
        ...
        log.warn("Message key, value", record.value() );
        log.error("Key for failed message : " + record.key());
        log.error("Base64 encoded value for failed message : " + new String(Base64.encodeBase64(toByteArray(record.value()))));
    ...
    public static byte[] toByteArray(Object message) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            log.error("Error in serializating object " );
        }
        return stream;
    }
